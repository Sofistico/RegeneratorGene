...
namespace RimWorld
{
	public class JobGiver_BingeFood : JobGiver_Binge
	{
		...
		{
			if (FoodUtility.TryFindBestFoodSourceFor(pawn, pawn, desperate: true, out var foodSource, out var _, canRefillDispenser: false, canUseInventory: true, canUsePackAnimalInventory: false, allowForbidden: true, allowCorpse: true, allowSociallyImproper: true, allowHarvest: false, forceScanWholeMap: false, ignoreReservations: false, calculateWantedStackCount: false, FoodPreferability.RawTasty))
			{
				return foodSource;
			}
			return null;
