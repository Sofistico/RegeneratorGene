...
namespace RimWorld
{
	public class WildAnimalSpawner
	{
		...
		private static readonly SimpleCurve PollutionAnimalSpawnChanceFromPollutionCurve = new SimpleCurve
		{
		...
		private float DesiredAnimalDensity
		{
			get
			{
				...
				{
					animalDensity *= PollutionToAnimalDensityFactorCurve.Evaluate(Find.WorldGrid[map.Tile].pollution);
				}
