...
namespace RimWorld
{
	public class ITab_Genes : ITab
	{
		...
		private static Thing ThingWithGenes()
		{
			...
			if ((building_GrowthVat = singleSelectedThing as Building_GrowthVat) != null)
			{
		...
		{
			Pawn pawn;
			if ((pawn = thing as Pawn) != null && pawn.genes != null)
			{
				return pawn;
			}
			Corpse corpse;
			if ((corpse = thing as Corpse) != null && corpse.InnerPawn.genes != null)
			{
