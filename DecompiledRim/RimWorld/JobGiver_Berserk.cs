...
namespace RimWorld
{
	public class JobGiver_Berserk : ThinkNode_JobGiver
	{
		...
		{
			Pawn pawn2;
			return (Pawn)AttackTargetFinder.BestAttackTarget(pawn, TargetScanFlags.NeedReachable, (Thing x) => (pawn2 = x as Pawn) != null && pawn2.Spawned && !pawn2.Downed && !pawn2.IsInvisible(), 0f, maxAttackDistance, default(IntVec3), float.MaxValue, canBashDoors: true);
		}
