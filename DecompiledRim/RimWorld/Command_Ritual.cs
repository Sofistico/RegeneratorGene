		...
		protected override GizmoResult GizmoOnGUIInt(Rect butRect, GizmoRenderParms parms)
		{
			if (!disabled)
			{
				...
				else if (ritual.def.sourcePawnRoleDef != null && ritual.def.sourceAbilityDef != null)
				{
					...
					Precept_RoleSingle precept_RoleSingle;
					if (precept_Role != null && (precept_RoleSingle = precept_Role as Precept_RoleSingle) != null && precept_RoleSingle.ChosenPawnSingle() != null)
					{
