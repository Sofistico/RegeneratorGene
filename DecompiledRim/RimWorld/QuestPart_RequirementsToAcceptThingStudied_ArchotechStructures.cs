	...
	public class QuestPart_RequirementsToAcceptThingStudied_ArchotechStructures : QuestPart_RequirementsToAcceptThingStudied
	{
		public override IEnumerable<GlobalTargetInfo> QuestLookTargets
		{
			get
			{
				...
				{
					AbandonedArchotechStructures abandonedArchotechStructures;
					if ((abandonedArchotechStructures = allWorldObject as AbandonedArchotechStructures) != null && !abandonedArchotechStructures.archotechStructures.NullOrEmpty() && abandonedArchotechStructures.archotechStructures.Contains(thing))
					{
