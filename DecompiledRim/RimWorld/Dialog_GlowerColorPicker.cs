...
namespace RimWorld
{
	public class Dialog_GlowerColorPicker : Window
	{
		...
		private static readonly List<Color> colors = new List<Color>
		{
			...
			Color.HSVToRGB(0.055555556f, 1f, 1f),
			Color.HSVToRGB(0.055555556f, 0.5f, 1f),
			Color.HSVToRGB(0.055555556f, 0.33f, 1f),
			Color.HSVToRGB(0.111111112f, 1f, 1f),
			Color.HSVToRGB(0.111111112f, 0.5f, 1f),
			Color.HSVToRGB(0.111111112f, 0.33f, 1f),
			Color.HSVToRGB(355f / (678f * (float)Math.PI), 1f, 1f),
			Color.HSVToRGB(355f / (678f * (float)Math.PI), 0.5f, 1f),
			Color.HSVToRGB(355f / (678f * (float)Math.PI), 0.33f, 1f),
			...
			Color.HSVToRGB(0.333333343f, 1f, 1f),
			Color.HSVToRGB(0.333333343f, 0.5f, 1f),
			Color.HSVToRGB(0.333333343f, 0.33f, 1f),
		...
		private static void ColorPalette(ref RectDivider layout, ref Color color, Color defaultColor, out float paletteHeight)
		{
			using (new TextBlock(TextAnchor.MiddleLeft))
			{
				...
				Widgets.ColorBox(rectDivider5.NewCol(num), ref color, defaultDarklight);
		...
		public override void DoWindowContents(Rect inRect)
		{
			using (TextBlock.Default())
			{
				...
				defaultColor.a = 1f;
				ColorPalette(ref layout, ref color, defaultColor, out var paletteHeight);
