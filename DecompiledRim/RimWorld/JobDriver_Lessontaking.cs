...
namespace RimWorld
{
	public class JobDriver_Lessontaking : JobDriver
	{
		...
		public override string GetReport()
		{
			...
			JobDriver_Lessongiving jobDriver_Lessongiving;
			if ((jobDriver_Lessongiving = Teacher?.jobs?.curDriver as JobDriver_Lessongiving) != null && jobDriver_Lessongiving.taughtSkill != null)
			{
				text = text + " (" + jobDriver_Lessongiving.taughtSkill.defName + ")";
			}
			return text;
		}
