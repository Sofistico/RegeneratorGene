...
namespace RimWorld
{
	public abstract class ScenPart_ThingCount : ScenPart
	{
		...
		public override bool TryMerge(ScenPart other)
		{
			...
			if (scenPart_ThingCount != null && GetType() == scenPart_ThingCount.GetType() && thingDef == scenPart_ThingCount.thingDef && stuff == scenPart_ThingCount.stuff && quality == scenPart_ThingCount.quality && count >= 0 && scenPart_ThingCount.count >= 0)
			{
