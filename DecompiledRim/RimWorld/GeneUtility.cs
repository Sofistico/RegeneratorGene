...
namespace RimWorld
{
	...
	public static class GeneUtility
	{
		...
		private static readonly GeneCount[] GeneCountProbabilities;

		public static readonly Color GCXColor;

		public static readonly Color METColor;

		public static readonly Color ARCColor;

		private static List<GeneSymbolPack> tmpSymbolPacks;

		private static List<GeneDef> tmpGenes;

		private static HashSet<GeneDefWithType> tmpOverriddenGenes;

		private static List<GeneDefWithType> tmpTypedGenes;
		...
		public static bool IsBloodfeeder(this Pawn pawn)
		{
			...
			return pawn.genes.HasGene(GeneDefOf.Bloodfeeder);
		}
		...
		public static bool SterileGenes(this Pawn pawn)
		{
			...
			{
				if (genesListForReading[i].def.sterilize)
				{
					return true;
				}
			}
		...
		public static void SatisfyChemicalGenes(Pawn pawn)
		{
			...
			foreach (Gene item in pawn.genes.GenesListForReading)
			{
				...
				if ((gene_ChemicalDependency = item as Gene_ChemicalDependency) != null)
				{
		...
		public static bool IsBaseliner(this Pawn pawn)
		{
			...
			{
				return pawn.genes.Xenotype == XenotypeDefOf.Baseliner;
			}
			return true;
		}
		...
		static GeneUtility()
		{
			GeneCount[] array = new GeneCount[6];
			...
			array[5] = geneCount;
			GeneCountProbabilities = array;
			GCXColor = new ColorInt(105, 213, 240).ToColor;
			METColor = new ColorInt(247, 72, 160).ToColor;
			ARCColor = new ColorInt(214, 219, 61).ToColor;
			tmpSymbolPacks = new List<GeneSymbolPack>();
			tmpGenes = new List<GeneDef>();
			tmpOverriddenGenes = new HashSet<GeneDefWithType>();
			tmpTypedGenes = new List<GeneDefWithType>();
		}
	}
}
