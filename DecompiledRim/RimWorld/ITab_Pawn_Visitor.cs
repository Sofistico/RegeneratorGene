		...
		protected override void FillTab()
		{
			...
			if (isPrisonerOfColony)
			{
				...
				else
				{
					...
					taggedString3 = ((isHealthy && !isInMentalState) ? (base.SelPawn.Faction.NameColored + " " + i.ToStringWithSign()) : ((!isHealthy) ? ("None".Translate() + " (" + "UntendedInjury".Translate().ToLower() + ")") : ((!isInMentalState) ? "None".Translate() : ("None".Translate() + " (" + base.SelPawn.MentalState.InspectLine + ")"))));
				}
			...
			if (isSlaveOfColony)
			{
				...
				if (need_Suppression != null)
				{
					...
					else
					{
						...
						taggedString8 = ((isHealthy2 && !isInMentalState2) ? (faction.NameColored + " " + i2.ToStringWithSign()) : ((!isHealthy2) ? ("None".Translate() + " (" + "UntendedInjury".Translate().ToLower() + ")") : ((!isInMentalState2) ? "None".Translate() : ("None".Translate() + " (" + base.SelPawn.MentalState.InspectLine + ")"))));
					}
