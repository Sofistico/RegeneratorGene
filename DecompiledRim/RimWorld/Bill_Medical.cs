	...
	public class Bill_Medical : Bill
	{
		...
		public override bool CompletableEver
		{
			get
			{
				...
				Recipe_Surgery recipe_Surgery;
				if ((recipe_Surgery = recipe.Worker as Recipe_Surgery) != null && !recipe_Surgery.CompletableEver(GiverPawn))
				{
					return false;
				}
				if (recipe == RecipeDefOf.ImplantXenogerm && xenogerm == null)
				{
					return false;
				}
