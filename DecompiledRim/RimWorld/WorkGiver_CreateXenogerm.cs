...
namespace RimWorld
{
	public class WorkGiver_CreateXenogerm : WorkGiver_Scanner
	{
		...
		{
			Building_GeneAssembler building_GeneAssembler;
			if ((building_GeneAssembler = t as Building_GeneAssembler) == null)
			{
				return false;
			}
		...
		public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			...
			return JobMaker.MakeJob(JobDefOf.CreateXenogerm, t);
		}
