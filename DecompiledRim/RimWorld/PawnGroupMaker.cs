...
namespace RimWorld
{
	public class PawnGroupMaker
	{
		...
		public bool CanGenerateFrom(PawnGroupMakerParms parms)
		{
			...
			RaidStrategyWorker_WithRequiredPawnKinds raidStrategyWorker_WithRequiredPawnKinds;
			if (parms.raidStrategy != null && (raidStrategyWorker_WithRequiredPawnKinds = parms.raidStrategy.Worker as RaidStrategyWorker_WithRequiredPawnKinds) != null && !raidStrategyWorker_WithRequiredPawnKinds.CanUseWithGroupMaker(this))
			{
				return false;
			}
