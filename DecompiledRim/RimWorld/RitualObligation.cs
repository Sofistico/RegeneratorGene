	...
	public class RitualObligation : IExposable, ILoadReferenceable
	{
		...
		public TaggedString LetterText
		{
			get
			{
				...
				Corpse corpse;
				if ((corpse = targetA.Thing as Corpse) != null)
				{
