...
namespace RimWorld
{
	public abstract class JobDriver_RopeToDestination : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			Toil topOfLoop2 = Toils_General.Label();
			yield return topOfLoop2;
			...
			yield return Toils_Jump.JumpIf(topOfLoop2, FindAnotherAnimalToRope);
			topOfLoop2 = Toils_General.Label();
			yield return topOfLoop2;
			...
			yield return toil;
			yield return Toils_Jump.JumpIf(topOfLoop2, UpdateDestination);
			topOfLoop2 = Toils_General.Wait(60, TargetIndex.A);
			topOfLoop2.AddPreTickAction(delegate
			{
				ProcessRopeesThatHaveArrived(roperWaitingAtDest: true);
			});
			yield return topOfLoop2;
			yield return Toils_Jump.JumpIf(topOfLoop2, () => pawn.roping.IsRopingOthers);
		}
		...
		private bool FindAnotherAnimalToRope()
		{
			...
			bool AnimalValidator(Thing thing)
			{
				...
				return ShouldOpportunisticallyRopeAnimal(pawn);
			}
		}
	}
}
