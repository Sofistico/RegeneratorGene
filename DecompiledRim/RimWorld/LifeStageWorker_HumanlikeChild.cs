...
namespace RimWorld
{
	public class LifeStageWorker_HumanlikeChild : LifeStageWorker
	{
		...
		public override void Notify_LifeStageStarted(Pawn pawn, LifeStageDef previousLifeStage)
		{
			...
			bool flag = ModsConfig.IdeologyActive && pawn.ideo != null && pawn.Ideo == null && pawn.ideo.TryJoinIdeoFromExposures();
			...
			PawnBioAndNameGenerator.FillBackstorySlotShuffled(pawn, BackstorySlot.Childhood, ChildBackstoryFilters, pawn.Faction?.def);
		}
	}
}
