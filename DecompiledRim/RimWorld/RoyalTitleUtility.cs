...
namespace RimWorld
{
	public static class RoyalTitleUtility
	{
		...
		{
			faction = null;
			if (pawn.Faction != null && pawn.Faction.IsPlayer && pawn.royalty != null && pawn.royalty.CanUpdateTitleOfAnyFaction(out faction) && GetCurrentBestowingCeremonyQuest(pawn, faction) == null)
			{
		...
		{
			if (pawn.Faction != null && pawn.Faction.IsPlayer && pawn.royalty != null && pawn.royalty.CanUpdateTitle(faction) && GetCurrentBestowingCeremonyQuest(pawn, faction) == null)
			{
				return pawn.MapHeld != null;
			}
			return false;
