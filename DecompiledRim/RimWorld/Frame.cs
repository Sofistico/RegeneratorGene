	...
	public class Frame : Building, IThingHolder, IConstructible, IStorageGroupMember, IStoreSettingsParent
	{
		...
		public void CompleteConstruction(Pawn worker)
		{
			...
			if (thingDef != null)
			{
				...
				if ((building_Storage = thing as Building_Storage) != null && storageSettings != null)
				{
		...
		public void FailConstruction(Pawn worker)
		{
			...
			if (def.entityDefToBuild.blueprintDef != null)
			{
				...
				if ((storageGroupMember = blueprint_Build as IStorageGroupMember) != null)
				{
					storageGroupMember.Group = storageGroup;
				}
				Blueprint_Storage blueprint_Storage;
				if ((blueprint_Storage = blueprint_Build as Blueprint_Storage) != null && storageSettings != null)
				{
