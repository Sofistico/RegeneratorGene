	...
	public class FleshTypeDef : Def
	{
		...
		public class Wound
		{
			...
			public bool Fits(Hediff hediff)
			{
				...
				if (missingBodyPartFresh.HasValue && (hediff_MissingPart = hediff as Hediff_MissingPart) != null && missingBodyPartFresh.Value != (hediff_MissingPart.IsFresh || hediff_MissingPart.Bleeding))
				{
					return false;
				}
				return true;
