...
namespace RimWorld
{
	public class StatPart_Genes : StatPart
	{
		...
		{
			Genepack genepack;
			if (ModsConfig.BiotechActive && req.HasThing && (genepack = req.Thing as Genepack) != null && genepack.GeneSet != null)
			{
		...
		public override string ExplanationPart(StatRequest req)
		{
			...
			Genepack genepack;
			if (!req.HasThing || (genepack = req.Thing as Genepack) == null || genepack.GeneSet == null)
			{
				return text;
			}
