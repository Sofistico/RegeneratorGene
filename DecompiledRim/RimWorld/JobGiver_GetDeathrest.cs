...
namespace RimWorld
{
	public class JobGiver_GetDeathrest : ThinkNode_JobGiver
	{
		...
		protected override Job TryGiveJob(Pawn pawn)
		{
			...
			Lord lord = pawn.GetLord();
			Building_Bed building_Bed = (((lord == null || lord.CurLordToil == null || lord.CurLordToil.AllowRestingInBed) && !pawn.IsWildMan() && (!pawn.InMentalState || pawn.MentalState.AllowRestingInBed) && !(pawn.roping?.IsRoped ?? false)) ? RestUtility.FindBedFor(pawn) : null);
