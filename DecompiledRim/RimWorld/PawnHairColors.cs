...
namespace RimWorld
{
	public static class PawnHairColors
	{
		...
		public static readonly Color DarkBrown = new Color(0.3529412f, 58f / 255f, 32f / 255f);

		public static readonly Color ReddishBrown = new Color(44f / 85f, 83f / 255f, 47f / 255f);

		public static readonly Color SandyBlonde = new Color(193f / 255f, 146f / 255f, 0.333333343f);

		public static readonly Color Blonde = new Color(79f / 85f, 202f / 255f, 52f / 85f);
		...
		public static GeneDef RandomHairColorGene(Color skinColor)
		{
			if (HairColorGenes.TryRandomElementByWeight((GeneDef g) => (!PawnSkinColors.IsDarkSkin(skinColor)) ? g.selectionWeight : (g.selectionWeight * g.selectionWeightFactorDarkSkin), out var result))
			{
				return result;
			}
			return null;
