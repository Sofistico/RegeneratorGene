...
namespace RimWorld
{
	public class RitualObligationTargetWorker_GraveWithTarget : RitualObligationTargetFilter
	{
		...
		protected override RitualTargetUseReport CanUseTargetInternal(TargetInfo target, RitualObligation obligation)
		{
			...
			return target.HasThing && (building_Grave = target.Thing as Building_Grave) != null && (building_Grave.Corpse == obligation.targetA.Thing || building_Grave.Corpse?.InnerPawn == obligation.targetA.Thing);
		}
