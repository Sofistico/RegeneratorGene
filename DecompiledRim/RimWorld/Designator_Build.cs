	...
	public class Designator_Build : Designator_Place
	{
		...
		public override ThingDef StuffDef
		{
			get
			{
				...
				ThingDef thingDef2 = entDef as ThingDef;
		...
		public override ThingStyleDef ThingStyleDefForPreview
		{
			get
			{
				...
				ThingDef thingDef;
				if ((thingDef = entDef as ThingDef) != null)
				{
		...
		public ThingStyleDef ThingStyleDefNonPreceptSource
		{
			...
			{
				ThingDef thingDef;
				if ((thingDef = PlacingDef as ThingDef) != null)
				{
		...
		public Designator_Build(BuildableDef entDef)
		{
			...
			eyedropper = new Designator_Eyedropper(delegate(ColorDef newCol)
			{
				...
				{
					Designator_Dropdown designator_Dropdown;
					if (item.colorDef == newCol && (designator_Dropdown = BuildCopyCommandUtility.FindAllowedDesignatorRoot(item) as Designator_Dropdown) != null)
					{
		...
		public override void DesignateSingleCell(IntVec3 c)
		{
			...
			if (DebugSettings.godMode || entDef.GetStatValueAbstract(StatDefOf.WorkToBuild, StuffDef) == 0f)
			{
				...
				else
				{
					...
					Building building;
					if (sourcePrecept != null && (building = thing2 as Building) != null)
					{
