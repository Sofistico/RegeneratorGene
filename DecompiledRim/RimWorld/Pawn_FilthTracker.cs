...
namespace RimWorld
{
	public class Pawn_FilthTracker : IExposable
	{
		...
		public void Notify_EnteredNewCell()
		{
			...
			else if (pawn.RaceProps.Animal && FilthMaker.TryMakeFilth(pawn.Position, pawn.Map, ThingDefOf.Filth_AnimalFilth, 1, AdditionalFilthSourceFlags | FilthSourceFlags.Pawn))
			{
