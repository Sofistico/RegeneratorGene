...
namespace RimWorld
{
	public class FoodRestrictionDatabase : IExposable
	{
		...
		public void CreateIdeologyFoodRestrictions()
		{
			...
			if (foodRestrictions.FirstOrDefault((FoodRestriction fr) => fr.label == (string)vegLabel) == null)
			{
				FoodRestriction foodRestriction = MakeNewFoodRestriction();
			...
			if (foodRestrictions.FirstOrDefault((FoodRestriction fr) => fr.label == (string)carnivoreLabel) == null)
			{
				FoodRestriction foodRestriction2 = MakeNewFoodRestriction();
			...
			if (foodRestrictions.FirstOrDefault((FoodRestriction fr) => fr.label == (string)cannibalLabel) == null)
			{
				FoodRestriction foodRestriction3 = MakeNewFoodRestriction();
			...
			if (foodRestrictions.FirstOrDefault((FoodRestriction fr) => fr.label == (string)insectMeatLabel) != null)
			{
				return;
			}
			FoodRestriction foodRestriction4 = MakeNewFoodRestriction();
