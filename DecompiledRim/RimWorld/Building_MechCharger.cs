...
namespace RimWorld
{
	...
	public class Building_MechCharger : Building
	{
		...
		private float WasteProducedPerTick => currentlyChargingMech.GetStatValue(StatDefOf.WastepacksPerRecharge) * (0.000833333354f / currentlyChargingMech.needs.energy.MaxLevel);
		...
		public override void Tick()
		{
			...
			{
				currentlyChargingMech.needs.energy.CurLevel += 0.000833333354f;
		...
		public override IEnumerable<Gizmo> GetGizmos()
		{
			...
			command_Action.defaultLabel = "DEV: Waste 100%";
			...
			command_Action2.defaultLabel = "DEV: Waste +25%";
			...
			command_Action3.defaultLabel = "DEV: Waste 0%";
			...
			if (!Container.innerContainer.Any)
			{
				...
				command_Action4.defaultLabel = "DEV: Generate waste";
		...
		public override void Draw()
		{
			...
			Vector3 b = Vector3.Lerp(DrawPos, InteractionCell.ToVector3Shifted(), num);
			b.y = AltitudeLayer.BuildingOnTop.AltitudeFor();
			drawPos.y = AltitudeLayer.BuildingOnTop.AltitudeFor();
			GenDraw.DrawLineBetween(drawPos, b, WireMaterial, 1f);
		}
