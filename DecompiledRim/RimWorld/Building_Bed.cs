...
namespace RimWorld
{
	public class Building_Bed : Building
	{
		...
		public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn myPawn)
		{
			...
			{
				if (HealthAIUtility.ShouldHaveSurgeryDoneNow(myPawn) && !WorkGiver_PatientGoToBedTreatment.AnyAvailableDoctorFor(myPawn))
				{
					yield return new FloatMenuOption("UseMedicalBed".Translate() + " (" + "NoDoctor".Translate() + ")", null);
				}
				else
				{
