...
namespace RimWorld
{
	public static class PawnsFinder
	{
		...
		private static List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive_Colonists_NoSlaves_Result = new List<Pawn>();
		...
		private static List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive_FreeColonists_NoSuspended_Result = new List<Pawn>();
		...
		private static List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive_SlavesOfColony_Result = new List<Pawn>();
		...
		private static List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive_Colonists_OfXenotype_Result = new List<Pawn>();
		...
		public static List<Pawn> AllMapsCaravansAndTravelingTransportPods_Alive_Colonists_NoSlaves
		{
			get
			{
				allMapsCaravansAndTravelingTransportPods_Alive_Colonists_NoSlaves_Result.Clear();
				List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive = AllMapsCaravansAndTravelingTransportPods_Alive;
				for (int i = 0; i < allMapsCaravansAndTravelingTransportPods_Alive.Count; i++)
				{
					if (allMapsCaravansAndTravelingTransportPods_Alive[i].IsColonist && !allMapsCaravansAndTravelingTransportPods_Alive[i].IsSlave)
					{
						allMapsCaravansAndTravelingTransportPods_Alive_Colonists_NoSlaves_Result.Add(allMapsCaravansAndTravelingTransportPods_Alive[i]);
					}
				}
				return allMapsCaravansAndTravelingTransportPods_Alive_Colonists_NoSlaves_Result;
			}
		}
		...
		public static List<Pawn> AllMapsCaravansAndTravelingTransportPods_Alive_FreeColonists_NoSuspended
		{
			get
			{
				allMapsCaravansAndTravelingTransportPods_Alive_FreeColonists_NoSuspended_Result.Clear();
				List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive = AllMapsCaravansAndTravelingTransportPods_Alive;
				for (int i = 0; i < allMapsCaravansAndTravelingTransportPods_Alive.Count; i++)
				{
					...
					{
						allMapsCaravansAndTravelingTransportPods_Alive_FreeColonists_NoSuspended_Result.Add(allMapsCaravansAndTravelingTransportPods_Alive[i]);
					}
				}
				return allMapsCaravansAndTravelingTransportPods_Alive_FreeColonists_NoSuspended_Result;
			}
		}
		...
		public static List<Pawn> AllMapsCaravansAndTravelingTransportPods_Alive_FreeColonists_NoCryptosleep
		{
			get
			{
				...
				for (int i = 0; i < allMapsCaravansAndTravelingTransportPods_Alive.Count; i++)
				{
					if (allMapsCaravansAndTravelingTransportPods_Alive[i].IsFreeColonist && !allMapsCaravansAndTravelingTransportPods_Alive[i].InCryptosleep)
					{
		...
		public static List<Pawn> AllMapsCaravansAndTravelingTransportPods_Alive_SlavesOfColony
		{
			get
			{
				allMapsCaravansAndTravelingTransportPods_Alive_SlavesOfColony_Result.Clear();
				List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive = AllMapsCaravansAndTravelingTransportPods_Alive;
				for (int i = 0; i < allMapsCaravansAndTravelingTransportPods_Alive.Count; i++)
				{
					if (allMapsCaravansAndTravelingTransportPods_Alive[i].IsSlaveOfColony)
					{
						allMapsCaravansAndTravelingTransportPods_Alive_SlavesOfColony_Result.Add(allMapsCaravansAndTravelingTransportPods_Alive[i]);
					}
				}
				return allMapsCaravansAndTravelingTransportPods_Alive_SlavesOfColony_Result;
			}
		}
		...
		public static List<Pawn> AllMapsCaravansAndTravelingTransportPods_Alive_Colonists_OfXenotype(XenotypeDef def)
		{
			allMapsCaravansAndTravelingTransportPods_Alive_Colonists_OfXenotype_Result.Clear();
			if (!ModsConfig.BiotechActive)
			{
				return allMapsCaravansAndTravelingTransportPods_Alive_Colonists_OfXenotype_Result;
			}
			List<Pawn> allMapsCaravansAndTravelingTransportPods_Alive_Colonists = AllMapsCaravansAndTravelingTransportPods_Alive_Colonists;
			for (int i = 0; i < allMapsCaravansAndTravelingTransportPods_Alive_Colonists.Count; i++)
			{
				if (allMapsCaravansAndTravelingTransportPods_Alive_Colonists[i].genes != null && allMapsCaravansAndTravelingTransportPods_Alive_Colonists[i].genes.Xenotype == def)
				{
					allMapsCaravansAndTravelingTransportPods_Alive_Colonists_OfXenotype_Result.Add(allMapsCaravansAndTravelingTransportPods_Alive_Colonists[i]);
				}
			}
			return allMapsCaravansAndTravelingTransportPods_Alive_Colonists_OfXenotype_Result;
		}
