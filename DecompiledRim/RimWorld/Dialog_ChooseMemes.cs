			...
			if (!newMemes.SetsEqual(ideo.memes))
			{
				...
				else
				{
					...
					if (ideo.PreceptsListForReading.Any())
					{
						...
						if ((ideoFoundation_Deity = ideo.foundation as IdeoFoundation_Deity) != null && memeCategory == MemeCategory.Structure)
						{
					...
					else
					{
						...
						if ((ideoFoundation_Deity2 = ideo.foundation as IdeoFoundation_Deity) != null)
						{
