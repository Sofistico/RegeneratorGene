			...
			get
			{
				...
				if (!parent.Spawned)
				{
					...
					if (parentHolder != null)
					{
						...
						if ((pawn_ApparelTracker = parentHolder as Pawn_ApparelTracker) != null)
						{
							pawn = pawn_ApparelTracker.pawn;
						}
						else if ((pawn_CarryTracker = parentHolder as Pawn_CarryTracker) != null)
						{
							pawn = pawn_CarryTracker.pawn;
						}
						else if ((pawn_EquipmentTracker = parentHolder as Pawn_EquipmentTracker) != null)
						{
