...
namespace RimWorld
{
	public class ExpansionDef : Def
	{
		...
		public ExpansionStatus Status
		{
			get
			{
				if ((linkedMod == "ludeon.rimworld.royalty" && Prefs.SimulateNotOwningRoyalty) || (linkedMod == "ludeon.rimworld.ideology" && Prefs.SimulateNotOwningIdology) || (linkedMod == "ludeon.rimworld.biotech" && Prefs.SimulateNotOwningBiotech))
				{
