	...
	public abstract class Thought : IExposable
	{
		...
		public virtual string Description
		{
			get
			{
				...
				description = ((def.Worker != null) ? def.Worker.PostProcessDescription(pawn, description) : (((thought_Memory = this as Thought_Memory) != null && thought_Memory.otherPawn != null) ? description.Formatted(pawn.Named("PAWN"), thought_Memory.otherPawn.Named("OTHERPAWN")).Resolve() : (((socialThought = this as ISocialThought) == null || socialThought.OtherPawn() == null) ? description.Formatted(pawn.Named("PAWN")).Resolve() : description.Formatted(pawn.Named("PAWN"), socialThought.OtherPawn().Named("OTHERPAWN")).Resolve())));
