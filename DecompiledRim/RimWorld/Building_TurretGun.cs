...
namespace RimWorld
{
	...
	public class Building_TurretGun : Building_Turret
	{
		...
		protected CompActivable activableComp;
		...
		private bool CanSetForcedTarget
		{
			get
			{
				if (mannableComp == null || !PlayerControlled)
				{
					return IsRocketswarmLauncher;
				}
				return true;
			}
		}
		...
		private bool IsActivable => activableComp != null;

		private bool IsRocketswarmLauncher => activableComp is CompActivable_RocketswarmLauncher;
		...
		public override void SpawnSetup(Map map, bool respawningAfterLoad)
		{
			...
			activableComp = GetComp<CompActivable>();
