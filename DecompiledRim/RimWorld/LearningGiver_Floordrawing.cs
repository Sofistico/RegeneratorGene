...
namespace RimWorld
{
	public class LearningGiver_Floordrawing : LearningGiver
	{
		...
		public static bool TryFindFloordrawingSpots(Pawn pawn, out IntVec3 drawFrom, out IntVec3 drawOn)
		{
			...
			{
				RegionTraverser.BreadthFirstTraverse(pawn.Position, pawn.Map, (Region from, Region r) => r.Allows(traverseParams, isDestination: false), (Region r) => !r.IsForbiddenEntirely(pawn) && r.TryFindRandomCellInRegion(CellValidator, out var _), desperate ? 200 : 40);
