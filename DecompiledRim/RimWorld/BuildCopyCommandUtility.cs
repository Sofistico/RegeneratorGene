...
namespace RimWorld
{
	public static class BuildCopyCommandUtility
	{
		...
		public static Command BuildCommand(BuildableDef buildable, ThingDef stuff, Precept_Building sourcePrecept, ThingStyleDef style, bool styleOverridden, string label, string description, bool allowHotKey, ColorInt? glowerColorOverride = null)
		{
