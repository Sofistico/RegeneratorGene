	...
	public class Designator_Replant : Designator_Install
	{
		...
		public override AcceptanceReport CanDesignateCell(IntVec3 c)
		{
			...
			foreach (Thing thing in c.GetThingList(base.Map))
			{
				...
				if ((blueprint_Install = thing as Blueprint_Install) != null && blueprint_Install.ThingToInstall.def.plant != null && blueprint_Install.ThingToInstall.def.plant.IsTree)
				{
