...
namespace RimWorld
{
	public class JobDriver_Tame : JobDriver_InteractAnimal
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			{
				Pawn pawn = base.job.GetTarget(TargetIndex.A).Thing as Pawn;
				if (pawn != null && AnimalPenUtility.NeedsToBeManagedByRope(pawn) && pawn.Faction == Faction.OfPlayer && AnimalPenUtility.GetCurrentPenOf(pawn, allowUnenclosedPens: false) == null)
				{
