...
namespace RimWorld
{
	public class FlameThrower : Projectile
	{
		...
		protected override void Impact(Thing hitThing, bool blockedByShield = false)
		{
			...
			Pawn t;
			if (hitThing != null && ((t = hitThing as Pawn) == null || Rand.Chance(FireUtility.ChanceToAttachFireFromEvent(t))))
			{
				hitThing.TryAttachFire(FireSizeRange.RandomInRange);
			}
			FireUtility.TryStartFireIn(position, map, FireSizeRange.RandomInRange);
