	...
	public class MapParent : WorldObject, IThingHolder
	{
		...
		public virtual void Abandon()
		{
			...
			if (Map.IsPlayerHome && !flag)
			{
				...
				{
					MemoryThoughtHandler memoryThoughtHandler = allMapsCaravansAndTravelingTransportPods_Alive_Colonist.needs?.mood?.thoughts?.memories;
					if (memoryThoughtHandler != null)
					{
						...
						if (allMapsCaravansAndTravelingTransportPods_Alive_Colonist.IsFreeNonSlaveColonist)
						{
