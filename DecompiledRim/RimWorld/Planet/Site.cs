	...
	public class Site : MapParent
	{
		...
		public override bool ShouldRemoveMapNow(out bool alsoRemoveWorldObject)
		{
			if (!base.Map.mapPawns.AnyPawnBlockingMapRemoval)
			{
				...
				if (parts.Any((SitePart x) => (sitePartWorker_AncientAltar = x.def.Worker as SitePartWorker_AncientAltar) != null && sitePartWorker_AncientAltar.ShouldKeepMapForRelic(x)))
				{
