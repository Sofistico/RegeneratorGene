	...
	public class QuestNode_Root_ShuttleCrash_Rescue : QuestNode
	{
		...
		protected override void RunInt()
		{
			...
			quest.Delay(120, delegate
			{
				...
				quest.ExitOnShuttle(map.Parent, allPassengers, Faction.OfEmpire, rescueShuttle, inSignal5, addFleeToil: false);
			...
			quest.Letter(LetterDefOf.NegativeEvent, inSignal2, null, Faction.OfEmpire, null, useColonistsFromCaravanArg: false, QuestPart.SignalListenMode.OngoingOnly, Gen.YieldSingle(asker), filterDeadPawnsFromLookTargets: false, "[askerDiedLetterText]", null, "[askerDiedLetterLabel]");
			...
			quest.End(QuestEndOutcome.InvalidPreAcceptance, 0, null, inSignal3, QuestPart.SignalListenMode.NotYetAcceptedOnly);
