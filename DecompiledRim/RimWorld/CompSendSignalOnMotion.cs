...
namespace RimWorld
{
	...
	public class CompSendSignalOnMotion : ThingComp
	{
		...
		public override void Notify_SignalReceived(Signal signal)
		{
			...
			if (signal.tag == CompAbilityEffect_Teleport.SkipUsedSignalTag && signal.args.TryGetArg("SUBJECT", out arg) && signal.args.TryGetArg("POSITION", out LocalTargetInfo arg2) && arg != null && arg.Map == parent.Map && parent.Position.DistanceTo(arg2.Cell) <= 40f)
			{
				Trigger(arg);
			}
		}
