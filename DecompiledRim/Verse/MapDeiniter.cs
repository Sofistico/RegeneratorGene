...
namespace Verse
{
	public static class MapDeiniter
	{
		...
		public static void Deinit(Map map)
		{
			...
			{
				Log.Error("Error while deiniting map: could not end all weather sustainers: " + ex3);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not end all effect sustainers: " + ex4);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not remove areas: " + ex5);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not remove things from the tick manager: " + ex6);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not notify things/regions/rooms/etc: " + ex7);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not remove things from thing listers: " + ex8);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not remove look targets: " + ex9);
			}
			try
			{
			...
			{
				Log.Error("Error while deiniting map: could not remove queued incidents: " + ex10);
			}
		}
