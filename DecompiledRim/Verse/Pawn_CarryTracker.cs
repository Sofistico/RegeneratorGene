...
namespace Verse
{
	public class Pawn_CarryTracker : IThingHolder, IExposable
	{
		...
		private void TryUpdateTransferables(Thing splitStack)
		{
			...
			if (splitStack != null && (jobDriver_HaulToTransporter = pawn.jobs?.curDriver as JobDriver_HaulToTransporter) != null)
			{
		...
		public void CarryHandsTick()
		{
			...
			Pawn pawn;
			if ((pawn = CarriedThing as Pawn) != null && pawn.DevelopmentalStage.Baby())
			{
