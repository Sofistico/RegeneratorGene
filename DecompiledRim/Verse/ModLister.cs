...
namespace Verse
{
	public static class ModLister
	{
		...
		public static bool IdeologyInstalled
		{
			get
			{
				if (ideologyInstalled)
				{
					return !Prefs.SimulateNotOwningIdology;
				}
				return false;
			}
		}
		...
		public static bool BiotechInstalled
		{
			get
			{
				if (biotechInstalled)
				{
					return !Prefs.SimulateNotOwningBiotech;
				}
				return false;
			}
		}
		...
		{
			return CheckDLC(RoyaltyInstalled || IdeologyInstalled || BiotechInstalled, featureNameSingular, "a Royalty or Ideology or Biotech", "RoyaltyInstalled or IdeologyInstalled or BiotechInstalled");
		}
	}
}
