...
namespace Verse
{
	public class Gene_PsychicBonding : Gene
	{
		...
		{
			base.PostAdd();
			Hediff_PsychicBond hediff_PsychicBond = pawn.health.hediffSet.GetFirstHediffOfDef(HediffDefOf.PsychicBond) as Hediff_PsychicBond;
		...
		public void RemoveBond()
		{
			...
			bondedPawn = null;
			Hediff_PsychicBond hediff_PsychicBond = base.pawn.health.hediffSet.GetFirstHediffOfDef(HediffDefOf.PsychicBond) as Hediff_PsychicBond;
			if (hediff_PsychicBond != null && hediff_PsychicBond.target == pawn)
			{
				base.pawn.health.RemoveHediff(hediff_PsychicBond);
			}
			Hediff_PsychicBond hediff_PsychicBond2 = pawn.health.hediffSet.GetFirstHediffOfDef(HediffDefOf.PsychicBond) as Hediff_PsychicBond;
