...
namespace Verse
{
	public static class DebugOutputsIncidents
	{
		...
		public static void TraderKindThings()
		{
			...
			{
				string defName = allDef.defName;
				defName = defName.Replace("_", "\n");
				defName = defName.Shorten();
				list.Add(new TableDataGetter<ThingDef>(defName, (ThingDef td) => TradeabilityToString(td.tradeability)));
			}
			...
			static string TradeabilityToString(Tradeability tradeability)
			{
