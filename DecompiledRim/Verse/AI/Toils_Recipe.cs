	...
	public static class Toils_Recipe
	{
		...
		public static Toil DoRecipeWork()
		{
			...
			toil.WithProgressBar(TargetIndex.A, delegate
			{
				...
				Bill_Mech bill_Mech;
				float num = (((bill_Mech = curJob.bill as Bill_Mech) != null && bill_Mech.State == FormingCycleState.Formed) ? 300f : curJob.bill.recipe.WorkAmountTotal(unfinishedThing?.Stuff));
