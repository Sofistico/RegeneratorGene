	...
	public class StaticTextureAtlas
	{
		...
		public void Bake(bool rebake = false)
		{
			...
			try
			{
				...
				object[] obj = new object[4] { "TextureAtlas_", null, null, null };
				TextureAtlasGroupKey textureAtlasGroupKey = groupKey;
				obj[1] = textureAtlasGroupKey.ToString();
				obj[2] = "_";
				obj[3] = colorTexture.GetInstanceID();
				texture2D.name = string.Concat(obj);
				if (groupKey.hasMask)
				{
				...
				for (int j = 0; j < array.Length; j++)
				{
					...
					object[] obj2 = new object[4] { "TextureAtlasMesh_", null, null, null };
					textureAtlasGroupKey = groupKey;
					obj2[1] = textureAtlasGroupKey.ToString();
					obj2[2] = "_";
					obj2[3] = mesh.GetInstanceID();
					mesh.name = string.Concat(obj2);
